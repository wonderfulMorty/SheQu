        ...
        var tableIns = table.render({
            ...
            ,cols: [
                [
                    ...
                    ,{field:'name', title:'申请维修人'}
                    ,{field:'my_content', title:'维修描述'}
                    ,{field:'my_area', title:'维修区域'}
                    ,{field: 'pic0', title: '故障图片1',templet:'#pic0'}
                    ,{field: 'pic1', title: '故障图片2',templet:'#pic1'}
                    ,{field: 'pic2', title: '故障图片3',templet:'#pic2'}
                ]
            ]
        });
    });

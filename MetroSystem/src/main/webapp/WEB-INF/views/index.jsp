...
<!-- 顶部开始 -->
<div class="container">
    <div class="logo"><a href="${pageContext.request.contextPath}/personInfo">地铁信息管理系统</a></div>
<%--    <div class="left_open">--%>
        ...
        <li class="layui-nav-item">
            <a href="javascript:;">
               ...
               <%-- <img src="${pageContext.request.contextPath}/uploads/${sessionScope.user.getPhoto()}"/>--%>
                <img src="https://s3.bmp.ovh/imgs/2022/04/03/48cbb0bb8ac743b3.png"/>
            </a>
    ...
    <div id="side-nav">
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/line">
                            <i class="iconfont">&#xe70b;</i>
                            <cite>线路一览</cite>
                        </a>
                    </li >
...
<%--</script>--%>
<div class="footer">
    <div class="copyright">地铁线路信息 深圳市地铁集团有限公司 版权所有</div>
</div>
</body>
</html>
